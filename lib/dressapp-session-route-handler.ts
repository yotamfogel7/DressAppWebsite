...
/** Shared POST handler for shopper JWT proxy (see `/site-api/dressapp/session` and legacy `/api/dressapp/session`). */
export async function handleDressAppSessionPost(req: Request): Promise<Response> {
